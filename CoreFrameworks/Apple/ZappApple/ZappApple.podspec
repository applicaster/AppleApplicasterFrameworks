...
Pod::Spec.new do |s|
  ...
  s.source = { :git => 'https://github.com/applicaster/AppleApplicasterFrameworks.git', :tag => "2020.3.31.21-3-8" }
  ...
  s.source_files = 'CoreFrameworks/Apple/ZappApple/Files/Universal/**/*.{h,m,swift}'
  s.ios.source_files = 'CoreFrameworks/Apple/ZappApple/Files/ios/**/*.{swift}'
  s.tvos.source_files = 'CoreFrameworks/Apple/ZappApple/Files/tvos/**/*.{swift}'

  s.test_spec 'UnitTests' do |sp|
    sp.source_files = 'CoreFrameworks/Apple/ZappApple/Files/Tests/**'
  end
end
