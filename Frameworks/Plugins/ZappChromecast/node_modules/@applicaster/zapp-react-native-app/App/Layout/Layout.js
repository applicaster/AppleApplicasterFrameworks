...
export function LayoutComponent(props: Props) {
  const [contentExtraStyle, setContentExtraStyle] = React.useState({});
  const {
    appState: { appReady = {} },
    plugins,
    children,
  ...
  const contentStyle = { ...contentExtraStyle, ...containerStyle };
    ...
    <View>
      ...
      {appReady && (
        <Menu
          ...
          setContentExtraStyle={setContentExtraStyle}
        />
      )}
    </View>
  );
