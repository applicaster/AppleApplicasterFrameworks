Pod::Spec.new do |s|
  s.name             = "ZappAppleVideoTVEverywhere"
  s.version          = '0.0.1'
  s.summary          = "ZappAppleVideoTVEverywhere"
  s.description      = <<-DESC
  ZappAppleVideoTVEverywhere container.
                       DESC
  ...
  s.frameworks = 'AVKit'
  s.ios.frameworks = 'MediaPlayer', 'VideoSubscriberAccount'
